      ...
      <div class="content-wrapper">
        ...
        <div class="content">
          ...
          <div class="container-fluid">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title col-9">All Sub-Company</h3>
                <input type="text" class="form-control col-3" id="txt_subcompany" name="txt_subcompany" placeholder="Search Sub-Company"/>
              </div>
              <!-- /.card-header -->
